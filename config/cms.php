...
return [
    ...
    'templates' => [
        ...
        'home' => [
            'name' => 'Homepage',
            'sections' => ['hero', 'intro', 'audience', 'features', 'cta', 'google_reviews'],
            'schema' => [
                'meta.title' => ['type' => 'text', 'translatable' => true],
                'meta.description' => ['type' => 'textarea', 'translatable' => true],
                'meta.featured_image' => ['type' => 'media', 'localized_media' => true],
                ...
                'sections.audience.is_visible' => ['type' => 'boolean', 'preserve' => true],
                'sections.audience.panels.*.eyebrow' => ['type' => 'text', 'translatable' => true],
                'sections.audience.panels.*.heading' => ['type' => 'text', 'translatable' => true],
                'sections.audience.panels.*.body' => ['type' => 'textarea', 'translatable' => true],
                'sections.audience.panels.*.button_label' => ['type' => 'text', 'translatable' => true],
                'sections.audience.panels.*.button_url' => ['type' => 'url', 'preserve' => true],
                'sections.audience.panels.*.image_id' => ['type' => 'media', 'localized_media' => true],
        ...
        'home-alt' => [
            'name' => 'Homepage Alt',
            'sections' => ['hero', 'intro', 'audience', 'features', 'cta'],
            'schema' => [
                'meta.title' => ['type' => 'text', 'translatable' => true],
                'meta.description' => ['type' => 'textarea', 'translatable' => true],
                'meta.featured_image' => ['type' => 'media', 'localized_media' => true],
