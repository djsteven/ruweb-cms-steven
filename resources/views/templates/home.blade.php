...
@include('partials.clean-home-styles')

<section id="home-hero" class="ama-clean-hero" aria-label="AmaTierra retreat in Costa Rica">
...
<section id="home-intro" class="ama-clean-intro">
    <div class="ama-home-container">
        <h1 class="display-title">{{ $heroHeading }}</h1>
        @if($heroBody)
            <p>{{ $heroBody }}</p>
        @endif
    </div>
...
<section class="ama-home-audience ama-clean-audience">
    <div class="ama-home-container ama-audience-grid">
    @foreach($audiencePanels as $panel)
        ...
        <article>
            ...
            <div class="ama-audience-content">
                <div class="max-w-[680px]">
                    ...
                    @if($headingLines->isNotEmpty())
                        <h2 class="display-title">{{ $headingLines->implode(' ') }}</h2>
                    @endif
                    @if($panel['body'] ?? null)
