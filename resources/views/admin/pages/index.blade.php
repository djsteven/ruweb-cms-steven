...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
    ...
    <a href="{{ route('admin.pages.create') }}" class="inline-flex items-center gap-2 px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-medium rounded-md transition-colors">
...
@if ($pages->isEmpty())
    <div class="text-center py-20 text-gray-600">
        ...
        <a href="{{ route('admin.pages.create') }}" class="mt-4 inline-flex items-center gap-2 px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-medium rounded-md transition-colors">
            {{ __('admin.new_page') }}
        </a>
    </div>
@else
            ...
            <tbody class="divide-y divide-white/[0.04]">
                @foreach ($pages as $page)
                    <tr class="hover:bg-white/[0.02] transition-colors">
                        <td class="px-4 py-3">
                            <a href="{{ route('admin.pages.edit', $page) }}" class="text-sm text-white hover:text-emerald-400 transition-colors">
                                {{ $page->title }}
                            </a>
                        </td>
