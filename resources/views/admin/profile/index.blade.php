            ...
            <div class="grid sm:grid-cols-2 gap-4">
                <div class="sm:col-span-2">
                    ...
                    <input type="password" id="current_password" name="current_password"
                           class="w-full sm:w-1/2 bg-[#1a1a1a] border border-white/10 text-white text-sm rounded-md px-3 py-2 placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-sky-500/50 focus:border-sky-500/50">
